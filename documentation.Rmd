...
For the following analysis, the top 5 countries per region (Africa, Americas, Europe, Asia, Oceania) by publishing volume are included. For Oceania, only Australia and New Zealand are included as publishing volumes for other countries (e.g. Fiji) are extremely low.
