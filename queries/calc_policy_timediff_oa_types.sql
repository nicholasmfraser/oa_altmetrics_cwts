...
/* Calculate the time difference between an article being mentioned in a policy document,
for all access types (closed, gold, hybrid, bronze, green) */
SELECT
	'closed' AS type,
...
INNER JOIN
	altmetric_2017oct.dbo.policy t4
ON
